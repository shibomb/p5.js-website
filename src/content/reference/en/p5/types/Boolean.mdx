...
description: >
  ...
  <p>The <code>Boolean</code> operator <span class="code">&&</span> (AND) checks whether two
  ...
  <p>The relational operators <span class="code">></span>, <span class="code"><</span>,
  <span class="code">>=</span>, and <span class="code"><=</span> also produce <code>Boolean</code>
