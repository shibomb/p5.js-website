...
description: >
  <p>マウスが要素の上を移動するたびに、<a href="#/p5.Element/mouseMoved">mouseMoved()</a>
  メソッドが1回呼び出されます。</p>
...
params:
  - name: fxn
    description: >
      <p>function to call when the mouse  moves over the element. 
      <code>false</code> disables the function. /// todo /// Function|Boolean:
      マウスが要素の上を移動したときに発火する関数。代わりに <code>false</code>
