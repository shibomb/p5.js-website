...
description: >
  <p><a href="#/p5/number">数値</a> は、JavaScript の7つの <a
  href="https://developer.mozilla.org/ja/docs/Web/JavaScript/Data_structures#Primitive_values">プリミティブデータ型</a>
  のひとつです。</p>

  <p>数値は整数または小数です。</p>

  <p><a href="https://developer.mozilla.org/ja/docs/Glossary/number">数値の MDN
  エントリ</a></p>
