...
description: >
  <p><a href="#/p5/mouseDragged">mouseDragged()</a>
  関数は、マウスが移動し、マウスボタンが押されるたびに1回呼び出されます。</p>

  <p> <a href="#/p5/mouseDragged">mouseDragged()</a> 関数が定義されていない場合、代わりに <a
  href="#/p5/touchMoved">touchMoved()</a>
