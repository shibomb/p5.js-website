...
description: >
  <p>指定された半径と高さの円柱を描画します。</p>

  <p></p>

  <p>DetailX および detailY は、円柱の x 次元および y
  次元の細分割数を決定します。細分割が多いほど、円柱は滑らかに見えます。detailX
