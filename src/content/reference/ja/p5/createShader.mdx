...
description: >
  <p>提供された頂点シェーダーとフラグメントシェーダーのコードから新しい <a href="#/p5.Shader">p5.Shader</a>
  オブジェクトを作成します。</p>
  ...
  consistency in rendering, it's recommended to use the vertex shader shown in
  the example below. /// todo ///  add 1 line</p>
...
return:
  description: |-
    提供された頂点シェーダーとフラグメントシェーダーから作成されたシェーダーオブジェクト。
