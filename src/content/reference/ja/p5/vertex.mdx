...
description: >-
  <p>すべての図形は、一連の頂点を接続することで構築されます。</p>

  <p><a href="#/p5/vertex">vertex()</a>
  は、点、線、三角形、四角形、ポリゴンの頂点座標を指定するために使用されます。これは、<a
  href="#/p5/beginShape">beginShape()</a> および <a
  href="#/p5/endShape">endShape()</a> 関数内でのみ使用されます。</p>
