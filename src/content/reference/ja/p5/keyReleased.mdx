...
description: >
  <p><a href="#/p5/keyReleased">keyReleased()</a> 関数は、キーが離されるたびに1回呼び出されます。</p>

  <p><a href="#/p5/key">key</a> および <a href="#/p5/keyCode">keyCode</a>
  を参照してください。ブラウザーには、さまざまなキーイベントに対して異なるデフォルトの動作が関連付けられている場合があります。このイベントのデフォルトの動作を防ぐには、関数の最後に
