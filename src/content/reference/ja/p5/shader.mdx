...
description: >
  <p>次に描画される図形に使用される <a href="#/p5.Shader">p5.Shader</a> オブジェクトを設定します。</p>
  ...
  <p>カスタムシェーダーは、<a href="#/p5/createShader">createShader()</a> および <a
  href="#/p5/loadShader">loadShader()</a> 関数を使用して作成できます。</p>

  <p>デフォルトのシェーダーを復元するには、<a href="#/p5/resetShader">resetShader()</a>
  を使用してください。</p>
...
params:
  - name: s
    description: |
      <p>図形の描画に使用する <a href="#/p5.Shader">p5.Shader</a> オブジェクト。</p>
