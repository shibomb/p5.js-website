...
description: >
  <p>点 a、b、c、d の位置 t における曲線を評価します。</p>

  <p>パラメーター t は0から1の間で変化し、a と d は曲線のコントロールポイント、b と c は曲線の始点と終点です。これは x 座標で1回、y
  座標で2回行われ、t における曲線の位置を取得できます。</p>
...
return:
  description: |-
    <a href="#/p5/curve">曲線</a> 上の位置 t の値
