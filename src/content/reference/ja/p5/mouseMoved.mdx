...
description: >
  <p><a href="#/p5/mouseMoved">mouseMoved()</a>
  関数は、マウスが移動し、マウスボタンが押されていない場合に呼び出されます。</p>

  <p>ブラウザーには、さまざまなマウスイベントに関連付けられたデフォルトの動作が異なる場合があります。このイベントのデフォルトの動作を防ぐには、「return
  false」をメソッドの最後に追加します。</p>
