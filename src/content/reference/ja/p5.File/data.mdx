...
file: src/dom/dom.js
description: >
  <p>ファイルが JSON であれば解析されたオブジェクト、XML であれば p5.XML、画像であれば画像データ、テキストであればテキストデータが含まれる
  URL 文字列。</p>

  <p>/// todo ///</p>

  <p>A string containing either the file's image data, text contents, or a
  parsed object in the case of JSON and <a href="#/p5.XML">p5.XML</a>
  objects.</p>
