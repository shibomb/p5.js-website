...
file: src/dom/dom.js
description: >
  <p>基礎となる File オブジェクト。</p>

  <p>このオブジェクトに対して File クラスの通常のメソッドが呼び出せます。</p>

  <p>/// todo ///</p>

  <p>Underlying <a href="https://developer.mozilla.org/en-US/docs/Web/API/File"
  target="_blank">File</a> object. All <code>File</code> properties and methods
  are accessible.</p>
