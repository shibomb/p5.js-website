...
description: >-
  <p>このフレームバッファがキャンバスのサイズに合わせて自動的にリサイズされるかどうかを取得または設定します。</p>

  <p></p>

  <p>現在自動サイズ調整が行われているかどうかを確認するには、このメソッドを引数なしで呼び出すか、このプロパティを設定するために真偽値を渡します。</p>
...
params:
  - name: autoSized
    description: >
      <p>(オプション) フレームバッファがキャンバスに合わせてサイズを変更すべきかどうか</p>
