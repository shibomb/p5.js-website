...
description: >-
  <p>指定されたブレンドモードを使用して、ひとつの画像からピクセルの領域をコピーし、他の画像に貼り付けます。</p>

  <p></p>

  <p>/// todo ///</p>

  <p>Copies a region of pixels from another <a href="#/p5.Image">p5.Image</a>
  object into this one. The <code>blendMode</code> parameter blends the images'
  colors to create different effects.</p>
