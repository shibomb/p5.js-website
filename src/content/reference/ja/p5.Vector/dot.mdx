...
description: >-
  ...
  <p>2つの独立したベクトルの内積を計算するバージョンは、静的メソッドです。より詳細なコンテキストについては、例を参照してください。</p>
  ...
  as the <code>x</code>, <code>y</code>, and <code>z</code> components of
  another vector.</p>

  <p>The static version of <code>dot()</code>, as in <code>p5.Vector.dot(v1,
  v2)</code>, is the same as calling <code>v1.dot(v2)</code>.</p>
...

  {
      ...
      "v": "p5.Vector: <a href=\"#/p5.Vector\">p5.Vector</a> to be dotted. /// todo /// p5.Vector: ベクトルの value 成分または <a href=\"#/p5.Vector\">p5.Vector</a>",
