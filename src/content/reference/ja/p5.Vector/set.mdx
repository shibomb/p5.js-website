...
description: >-
  <p>2つまたは3つの別々の変数、<a href="#/p5.Vector">p5.Vector</a> のデータ、または float
  配列の値を使用して、ベクトルの <code>x</code>、<code>y</code>、<code>z</code> 成分を設定します。</p>
  ...
  the vector using separate numbers, a <a href="#/p5.Vector">p5.Vector</a>
  object, or an array of numbers. Calling <code>set()</code> with no arguments
  sets the vector's components to 0.</p>
