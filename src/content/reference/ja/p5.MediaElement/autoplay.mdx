...
file: src/dom/dom.js
description: >
  <p>HTML5 メディア要素を自動再生するかどうかを設定します。</p>

  <p>引数が指定されていない場合、デフォルトで自動再生されます。</p>
  ...
  <code>media.autoplay(true)</code>, the media will automatically play. If
  <code>false</code> is passed, as in <code>media.autoPlay(false)</code>, it
  won't play automatically.</p>
