...
description: >-
  <p>新しい <a href="#/p5.Framebuffer">p5.Framebuffer</a> を p5.Graphics WebGL
  コンテキスト内に作成して返します。</p>

  <p></p>

  <p>これは <a href="#/p5/createFramebuffer">global createFramebuffer 関数</a>
  と同じパラメーターを取ります。</p>
  ...
  todo: param options not found in ja-legacy:
